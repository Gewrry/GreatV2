    ...
    <div class="flex min-h-screen bg-gray-100">
        ...
        <aside class="w-64 bg-white border-r border-gray-200 overflow-y-auto">
            ...
            <nav class="p-4 space-y-6">
                ...
                <!-- Modules Section -->
                <div>
                    <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Modules</h3>
                    <div class="space-y-1">
                        ...
                        <br>
                        <!-- Human Resource (with working route) -->
                        <x-nav-link href="{{ route('employee-info.create') }}"
                            :active="request()->routeIs('employee-info.*')">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <br>
                        <!-- RPT -->
                        <x-nav-link href="{{ route('rpt.index') }}" :active="false">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                            </svg>
                        ...
                        <x-nav-link href="#" :active="false">
                            ...
                            {{ __('Water System Inventory') }}
                        </x-nav-link>
                        <br>
                        <!-- WS Repair & Maintenance -->
                        <x-nav-link href="#" :active="false">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
