{{-- resources/views/modules/rpt/td/partials/_details.blade.php --}}
<div class="space-y-4">
    {{-- Workflow Steps --}}
    <div class="overflow-x-auto pb-4 custom-scrollbar-horizontal">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-1 space-y-6">
            {{-- Activity Logs --}}
            <div class="bg-white rounded-xl shadow overflow-hidden border border-gray-100 flex flex-col lg:h-full">
...
{{-- 🧩 Modals --}}
@include('modules.rpt.td.modals._cancel_td', ['td' => $td])
