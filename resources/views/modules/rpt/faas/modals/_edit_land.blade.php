    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-xl overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <form action="" method="POST" class="p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div><label class="block text-[10px] font-bold text-gray-400 uppercase mb-1.5">Latitude</label><input type="number" name="latitude" step="0.00000001" min="-90" max="90" class="w-full border-gray-200 border rounded-xl px-4 py-2.5 text-sm"></div>
                <div><label class="block text-[10px] font-bold text-gray-400 uppercase mb-1.5">Longitude</label><input type="number" name="longitude" step="0.00000001" min="-180" max="180" class="w-full border-gray-200 border rounded-xl px-4 py-2.5 text-sm"></div>
            </div>
