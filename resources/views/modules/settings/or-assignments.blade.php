                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-2xl border border-lumot/20 shadow-sm overflow-hidden">
                            ...
                            <div class="p-5 space-y-4">
                                ...
                                <div>
                                    <label
                                        class="block text-[10px] font-extrabold text-gray/50 uppercase mb-1.5">Cashier
                                        Name</label>
                                    @php
                                        $cashierName =
                                            \Illuminate\Support\Facades\DB::table('users')
                                                ...
                                                ->selectRaw(
                                                    "CONCAT(employee_info.first_name, ' ', employee_info.last_name) as full_name",
                                                )
                                                ->value('full_name') ??
                                            (Auth::user()->uname ?? 'Current User');
                                    @endphp
                                    <div
                                        class="w-full text-xs border border-lumot/30 rounded-xl px-3 py-2.5 bg-lumot/10 text-gray font-semibold cursor-not-allowed">
                                        {{ $cashierName }}
                                    </div>
                                            ...
                                            <tr
                                                ...
                                                <td class="px-4 py-3">
                                                    <span
                                                        ...
                                                        @elseif ($row->receipt_type === 'AF51') bg-purple-50 text-purple-600 @endif">
                                                        {{ $row->receipt_label ?? $row->receipt_type }}
                                                    </span>
                                                </td>
                                                <td class="px-4 py-3">
                                                    <span
                                                        class="text-xs font-semibold text-gray">{{ $row->cashier_name }}</span>
                                                </td>
                                                <td class="px-4 py-3 text-center">
                                                    <div class="flex items-center justify-center gap-1.5">
                                                        ...
                                                        <form
                                                            action="{{ route('bpls.settings.or-assignments.destroy', $row->id) }}"
                                                            method="POST"
