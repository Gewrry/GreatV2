    ...
    <div class="permit-page">
        ...
        <div class="permit-content">
            ...
            <div class="permit-header">
                <div class="seal">REPUBLIC<br>OF THE<br>PHILIPPINES<br>SEAL</div>
                ...
                <div class="seal">
                    LGU<br>{{ strtoupper(substr($entry->business_municipality ?? 'SAMPLE', 0, 5)) }}<br>SEAL</div>
            </div>
            ...
            {{-- Business ID + Permit Number --}}
            @if (!empty($entry->business_id))
                <div
                    style="font-size:11px;font-style:italic;text-align:center;color:#555;margin-bottom:4px;letter-spacing:.5px;">
                    Business ID: <strong style="color:#1a3a5c;">{{ $entry->business_id }}</strong>
                </div>
            @endif
