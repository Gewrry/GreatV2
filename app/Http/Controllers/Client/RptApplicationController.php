...
class RptApplicationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $application = RptOnlineApplication::create([
            ...
            'administrator_name'    => $validated['administrator_name'] ?? null,
            'administrator_address' => $validated['administrator_address'] ?? null,
            ...
            'blk_no'                => $validated['blk_no'] ?? null,
            'survey_no'             => $validated['survey_no'] ?? null,
            'boundary_north'        => $validated['boundary_north'] ?? null,
            'boundary_south'        => $validated['boundary_south'] ?? null,
            'boundary_east'         => $validated['boundary_east'] ?? null,
            'boundary_west'         => $validated['boundary_west'] ?? null,
            'property_description'  => $validated['property_description'] ?? null,
            'polygon_coordinates'   => isset($validated['polygon_coordinates']) ? json_decode($validated['polygon_coordinates'], true) : null,
            'status'                => 'pending',
        ]);
